...
func CalculatePhysicalDerivative32(t *testing.T, device *gocca.OCCADevice,
	...
	params = append(params,
		builder.Input("U").Bind(U),
		builder.Input("Rx").Bind(Rx).DeviceMemType(builder.Float32),
		builder.Input("Sx").Bind(Sx).DeviceMemType(builder.Float32),
		builder.Input("Tx").Bind(Tx).DeviceMemType(builder.Float32),
		builder.Input("Ry").Bind(Ry).DeviceMemType(builder.Float32),
		builder.Input("Sy").Bind(Sy).DeviceMemType(builder.Float32),
		builder.Input("Ty").Bind(Ty).DeviceMemType(builder.Float32),
		builder.Input("Rz").Bind(Rz).DeviceMemType(builder.Float32),
		builder.Input("Sz").Bind(Sz).DeviceMemType(builder.Float32),
		builder.Input("Tz").Bind(Tz).DeviceMemType(builder.Float32),
		builder.Output("DuDx").Bind(DuDx).DeviceMemType(builder.Float32),
		builder.Output("DuDy").Bind(DuDy).DeviceMemType(builder.Float32),
		builder.Output("DuDz").Bind(DuDz).DeviceMemType(builder.Float32),
		builder.Temp("Ur").Type(builder.Float64).Size(totalNodes),

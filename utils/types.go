...
func (e GeometryType) GetDimension() int {
	switch e {
	case Point:
		return 0
	case Line, Line3:
...
func (e GeometryType) GetNumNodes() int {
	switch e {
	case Point:
		return 1
	case Line:
...
func (e GeometryType) GetNumFaces() int {
	switch e {
	case Tet, Tet10:
		return 4
...
func (e GeometryType) GetCornerNodes() []int {
	switch e {
	case Line3:
		return []int{0, 1}
...
func GetElementFaces(elemType GeometryType, vertices []int) [][]int {
	switch elemType {
	case Tet, Tet10:
